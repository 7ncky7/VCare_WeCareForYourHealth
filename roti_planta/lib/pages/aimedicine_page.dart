...
class AiMedicinePage extends StatefulWidget {
  const AiMedicinePage({super.key});

  @override
  _AiMedicinePageState createState() => _AiMedicinePageState();
}

class _AiMedicinePageState extends State<AiMedicinePage> {
  ...
  Future<String> sendMessage(String message) async {
    try {
      final response = await http.post(
        Uri.parse('${AppConfig.baseUrl}/api/medicine-recommendation'),
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                localizations?.aiMedicineQuery ?? 'AI Medicine Query',
                              ...
                              Text(
                                localizations?.describeMedicine ??
                                    'Describe your medicine to me and I\'ll give you some recommendation.',
                          ...
                          children: [
                            Container(
                              ...
                              child: _messages.isEmpty
                                  ? Center(
                                      child: Text(
                                        // 'Start by sharing your inquiry...',
                                        localizations?.sharingMedicine ?? 'Start by sharing your inquiry...',
                                ...
                                Expanded(
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: localizations?.tellMeYourInquiry ?? 'Tell me your inquiry ...',
                                      filled: true,
