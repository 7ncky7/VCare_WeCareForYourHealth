...
class AiEmotionalPage extends StatefulWidget {
  const AiEmotionalPage({super.key});

  @override
  _AiEmotionalPageState createState() => _AiEmotionalPageState();
}

class _AiEmotionalPageState extends State<AiEmotionalPage> {
  ...
  Future<String> sendMessage(String message) async {
    try {
      final response = await http.post(
        Uri.parse('${AppConfig.baseUrl}/api/emotional-support'),
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                localizations?.aiEmotionalSupport ?? 'AI Emotional Support',
                              ...
                              Text(
                                localizations?.describeEmotions ??
                                    'Describe your emotions to me and I\'ll give you some tailored emotional values.',
                        ...
                        Image.asset(
                          'assets/images/emotional_icon.png',
                          height: 115,
                          color: const Color(0xFF852745),
                        ),
                      ],
                              ...
                              child: _messages.isEmpty
                                  ? Center(
                                      child: Text(
                                        ...
                                        localizations?.sharingFeelings ?? 'Start by sharing your feelings...',
                                ...
                                Expanded(
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: localizations?.tellMeHowYouFeel ?? 'Tell me how you feel ...',
                                      filled: true,
